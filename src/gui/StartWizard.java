...
public class StartWizard extends JFrame implements ActionListener{
    ...
    public StartWizard () throws FileNotFoundException, UnsupportedEncodingException {
        super();
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(buttonString.equals("Exit")) {
            ...
            try {
                SubWizard sub = new SubWizard(nameField.getText(), Integer.parseInt(otherPlayers.getText()));
                sub.setVisible(true);
